        ...
        <>
            <div class="mt-10 mx-auto max-w-sm w-full">
                <form onSubmit={onNewTodo}>
                    <input id="todo" name="todo" type="text" ref={inputRef} placeholder="Enter new Todo..." 
                    required class="w-full rounded-md py-1.5 px-3.5 ring-1 ring-inset ring-gray-300 placeholder: text-gray-400"/>
                </form>
            ...
            {todos.length > 0 ? (
                ...
                <div class="mt-10 flex justify-center text-center">
                    <div>
                        <img src="/i_can_fly.svg" alt="logo" />
                        <h2 class="text-2x1 font-bold mb-5">All tasks are completed</h2>
